...
export const IotAuthLayoutRoutes = [
  ...
  AuthLayoutChild (ProjectsComponent, 'projects'),
  AuthLayoutChild (ProjectSingleComponent, 'project/create'),
  AuthLayoutChild (ProjectEventsActionsComponent, 'project/events-and-actions/:id'),
  AuthLayoutChild (ProjectSingleComponent, 'project/:id'),
  AuthLayoutChild (ExperimentalComponent, 'experimental'),
  AuthLayoutChild (ProjectSingleComponent, 'create-project-from-source/:sourceId'),
