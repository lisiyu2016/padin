...
import { CloudProject, ILocation, AppState, INotification, IRole } from '@app/definitions';
...
export class NotificationService {
  ...
  public InvokeProjectCreate (project: CloudProject) {
    const title = 'Project Created Succesfully';
    this.StoreNotification({
      title,
      type: 'success',
  ...
  public InvokeProjectUpdate (project: CloudProject) {
  ...
  public InvokeProjectDelete (project: CloudProject) {
    this.StoreNotification({
      title: 'Your Project Deleted',
      type: 'error',
      status: 'icon-remove_circle',
      date: new Date(),
      message: project.name
